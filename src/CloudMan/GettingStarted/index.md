...
1. Head to the Cloud Launch application at [launch.usegalaxy.org/launch](https://launch.usegalaxy.org/launch) and fill the form with the required information. Here, use the access credentials created in the previous step (i.e., for the *access* and *secret key* fields). Give the cluster a name and protect access to it via a self-chosen password. You can also choose the type of cluster to configure here - see [this page](../ClusterTypes) for a description of the available options.
...
* [Cluster applications and services](../Services)
* [Sharing and publishing a cluster](../Sharing)
* [Customizing your cluster](/CloudMan/CustomizeGalaxyCloud)
* [Troubleshooting](../Troubleshooting)

Getting started guide for the old *cloudlaunch interface* can be found [here](Pre201509).
