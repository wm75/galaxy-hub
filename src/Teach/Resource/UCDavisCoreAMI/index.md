...
<div class='deploymentbox'>
 Resource:: **[UC Davis Bioinformatics Core Galaxy AMI](.)**
 Types:: AMI
 Domains:: **Genomics**
...
The current AMI (**ami-ab010aee**) was created for the [RNA-Seq and ChIP-Seq Analysis with Galaxy Workshop](../UCDavisRNAChIPWorkshop) course offered at the UC Davis Bioinformatics core, December 16-19, 2014
...
* [Workshop's resource page](../UCDavisCoreGalaxyCourse) on this wiki.
