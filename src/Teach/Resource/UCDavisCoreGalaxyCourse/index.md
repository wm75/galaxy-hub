...
<div class='deploymentbox'>
 Resource:: **[UC Davis Using Galaxy for Analysis of High Throughput Sequence Data Workshop](.)**
 Types:: Presentations, Tutorials, Exercises, Datasets, [AMI](../UCDavisCoreAMI)
...
This is a complete package of slides, examples, datasets, and [an accompanying Amazon Machine Image](../UCDavisCoreAMI).  
...
The easiest way to use this material is launch the workshop's [accompanying Amazon Machine Image (AMI)](../UCDavisCoreAMI).  It has all needed tools already installed on it.

## Datasets

The [workshop AMI](../UCDavisCoreAMI) also includes the example datasets used in the exercises. 

## Links

* [Workshop AMI](../UCDavisCoreAMI)
