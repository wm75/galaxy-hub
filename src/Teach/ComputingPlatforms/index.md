...
If you do use AWS-based and CloudMan-managed servers for your training, the Galaxy Project also provides a [Galaxy Workshop AMI](../WorkshopAMI) that comes preloaded with several examples that are used in project-run workshops.
