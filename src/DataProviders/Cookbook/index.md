...
Most of the examples that use python both here and in [/DataProviders](..) should be good starting points for
...
you may want to define a new [DataProvider](..).
...
All [DataProvider](..) classes should inherit at least from `datatypes.dataproviders.base.DataProvider`. If
