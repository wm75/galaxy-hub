...
[/VisualizationsRegistry/Cookbook](Cookbook).
...
For more information on visualization configuration options see [/VisualizationsRegistry/Configuration](Configuration).
...
For more information on template or static code files see [/VisualizationsRegistry/Code](Code).


---
## Further examples

For more examples on how the visualizations registry can be used see [/VisualizationsRegistry/Cookbook](Cookbook).
