...
You are strongly encouraged to [add your local Galaxy deployment](#add-your-galaxy-deployment) to this catalog so that the [Galaxy Community](..) can benefit from your experience.
...
* The results of [GalaxyAdmins questionnaires in 2012 and 2014](../GalaxyAdmins/Surveys).  These are about deployment details.
...
1. [Login|&action=login](.) to the wiki. If you don't have an account, you'll need to [create one|&action=newaccount](.).
