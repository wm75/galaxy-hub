...
The tracking information associated with Datasets in a History represent an experimental record of the methods, parameters, and other inputs. These methods are easily extracted into **[Workflows](../AdvancedWorkflow)**, making an analysis pathway transparent, reproducible, and *reusable*.
...
* Lower left corner
  ...
  * Display in [trackster|Galaxy Track Browser (GTB)](../Visualization) (optional)
...
* Direct links to view a dataset within a browser may include:
  * [Trackster "Galaxy Track Browser (GTB)"](../Visualization)
