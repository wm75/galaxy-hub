...
<br />
[Back to Basic Editing](../BasicEditing)
<br />
...
*If you **[extracted a workflow from a history](../Extract)**, and find that a **run is producing an error**, enter the workflow editor to **double check tool connections** and to **modify datatype assignments** (if needed) as one of your first customizing steps.*
<br /> <br />
...
<br />
<br />
It also lists **Workflows Shared with You** (if any). Under **Other Options** is the button for the special function described in the wiki *[How to turn your workflow into a tool...](../ToolPanel)*. 
<br />
...
Good idea! Read more about workflow operations not covered in this wiki, in others linked from here: **[Advanced Workflow](..)**
